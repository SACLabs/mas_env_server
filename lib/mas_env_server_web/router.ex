defmodule MasEnvServerWeb.Router do
  use MasEnvServerWeb, :router
  ...
  if Application.compile_env(:mas_env_server, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MasEnvServerWeb.Telemetry
